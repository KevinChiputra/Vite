...
const Sidenav = () => {
    ...
    return (
        <div>
            <AiOutlineMenu onClick={handleNav} className='fixed top-4 right-4 z-[99] md:hidden text-[#C3C3C3]'/>
            {
                nav ? (
                    <div className='fixed w-full h-screen flex bg-white/90 flex flex-col justify-center items-center z-20'>
